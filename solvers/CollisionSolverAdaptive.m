classdef CollisionSolverAdaptive < iFluidSolver
...
methods (Access = public)
    ...
    function obj = CollisionSolverAdaptive(coreObj, lperp, Options)        
...
methods (Access = protected)
    ...
    function [theta_next, u_next, w_next] = step(obj, theta_prev, u_prev, w_next, t, dt)
        ...
        % STEP 1: Figure out if step needs to be broken up into smaller
        % pieces.
