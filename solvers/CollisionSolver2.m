classdef CollisionSolver2 < iFluidSolver
...
methods (Access = public)
    ...
    function obj = CollisionSolver2(coreObj, lperp, Options)        
...
methods (Access = protected)
    ...
    function [theta, u, w] = initialize(obj, theta_init, u_init, w_init, t_array)
        ...
        [I, J] = obj.calcCollisionIntegral( 0, theta_init, u);
        obj.I_prev = I;
        obj.J_prev = J;
    ...
    function [theta_next, u_next, w_next] = step(obj, theta_prev, u_prev, w_next, t, dt)
        ...
        % Split step
%         u_mid = u_prev + 0.5*dt*obj.J_prev;
%         mid_temp = obj.theta_mid + 0.5*dt*obj.I_prev;
%         
%         [I, J] = obj.calcCollisionIntegral( t, mid_temp, u_mid);


        [I, J] = obj.calcCollisionIntegral( t, theta_prev, u_prev);

        
        theta_prev = theta_prev + dt*I;
        u_next  = u_prev + dt*J;
